...
namespace Nagarro.VendingMachine.Tests.Commands.Reports
{
    public class VolumeReportCommandTests
    {
        ...
        private readonly VolumeReportCommand command;

        public VolumeReportCommandTests()
        {
            authenticationService = new Mock<IAuthenticationService>();
            useCaseFactory = new Mock<IUseCaseFactory>();
            command = new VolumeReportCommand(authenticationService.Object, useCaseFactory.Object);
        }
